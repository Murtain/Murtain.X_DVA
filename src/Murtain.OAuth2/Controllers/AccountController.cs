...
namespace Murtain.OAuth2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (!result.Succeeded)
            {
                await _events.RaiseAsync(new UserLoginFailureEvent(model.Username, "Invalid login attempt."));
                ModelState.AddModelError("", AccountOptions.InvalidCredentialsErrorMessage);
            ...
            await Microsoft.AspNetCore.Http.AuthenticationManagerExtensions.SignInAsync(HttpContext, user.Id, user.UserName, props);
