...
namespace IdentityAdmin.Api.Models.ApiResource
{
    ...
    {
        public ApiResourceDetailDataResource(ApiResourceDetail apiResource, IUrlHelper url, ApiResourceMetaData metaData)
        {
        ...
        private IEnumerable<object> GetClaims(ApiResourceDetail apiResource, IUrlHelper url)
        {
        ...
        private IEnumerable<object> GetSecrets(ApiResourceDetail apiResource, IUrlHelper url)
        {
        ...
        private IEnumerable<object> GetScopes(ApiResourceDetail apiResource, IUrlHelper url)
        {
