...
namespace IdentityAdmin.Api.Controllers
{
    ...
    public class ClientController : Controller
    {
        ...
        public async Task<IActionResult> GetClientsAsync(string filter = null, int start = 0, int count = 100)
        {
        ...
        public async Task<IActionResult> GetClientAsync(string subject)
        {
        ...
        public async Task<IActionResult> CreateClientAsync(PropertyValue[] properties)
        {
        ...
        public async Task<IActionResult> DeleteClientAsync(string subject)
        {
            var meta = await GetCoreMetaDataAsync();
        ...
        public async Task<IActionResult> SetPropertyAsync(string subject, string type, [FromBody]string value)
        {
            if (String.IsNullOrWhiteSpace(subject))
            {
                ModelState["subject.String"].Errors.Clear();
        ...
        public async Task<IActionResult> AddClientClaimAsync(string subject, ClientClaimValue model)
        {
            if (String.IsNullOrWhiteSpace(subject))
            {
                ModelState["subject.String"].Errors.Clear();
        ...
        public async Task<IActionResult> RemoveClaimAsync(string subject, string id)
        {
            if (String.IsNullOrWhiteSpace(subject))
            {
                ModelState.AddModelError("", Messages.SubjectRequired);
        ...
        public async Task<IActionResult> AddClientSecretAsync(string subject, ClientSecretValue model)
        {
            if (String.IsNullOrWhiteSpace(subject))
            {
                ModelState["subject.String"].Errors.Clear();
        ...
        public async Task<IActionResult> RemoveClientSecretAsync(string subject, string id)
        {
            if (String.IsNullOrWhiteSpace(subject) ||
        ...
        public async Task<IActionResult> AddClientIdPRestrictionAsync(string subject, ClientIdPRestrictionValue model)
        {
            if (String.IsNullOrWhiteSpace(subject))
            {
                ModelState["subject.String"].Errors.Clear();
        ...
        public async Task<IActionResult> RemoveClientIdPRestrictionAsync(string subject, string id)
        {
        ...
        public async Task<IActionResult> AddClientPostLogoutRedirectUriAsync(string subject, ClientPostLogoutRedirectUriValue model)
        {
            if (String.IsNullOrWhiteSpace(subject))
            {
                ModelState["subject.String"].Errors.Clear();
        ...
        public async Task<IActionResult> RemoveClientPostLogoutRedirectUriAsync(string subject, string id)
        {
            if (String.IsNullOrWhiteSpace(subject) || String.IsNullOrWhiteSpace(id))
            {
                return NotFound();
        ...
        public async Task<IActionResult> AddClientRedirectUriAsync(string subject, ClientRedirectUriValue model)
        {
            if (String.IsNullOrWhiteSpace(subject))
            {
                ModelState["subject.String"].Errors.Clear();
        ...
        public async Task<IActionResult> RemoveClientRedirectUriAsync(string subject, string id)
        {
            if (String.IsNullOrWhiteSpace(subject) || String.IsNullOrWhiteSpace(id))
            {
                return NotFound();
        ...
        public async Task<IActionResult> AddClientCorsOriginAsync(string subject, ClientCorsOriginValue model)
        {
            if (String.IsNullOrWhiteSpace(subject))
            {
                ModelState["subject.String"].Errors.Clear();
        ...
        public async Task<IActionResult> RemoveClientCorsOriginAsync(string subject, string id)
        {
            if (String.IsNullOrWhiteSpace(subject) || String.IsNullOrWhiteSpace(id))
            {
                return NotFound();
        ...
        public async Task<IActionResult> AddClientCustomGrantTypeAsync(string subject, ClientCustomGrantTypeValue model)
        {
            if (String.IsNullOrWhiteSpace(subject))
            {
                ModelState["subject.String"].Errors.Clear();
        ...
        public async Task<IActionResult> RemoveClientCustomGrantTypeAsync(string subject, string id)
        {
            if (String.IsNullOrWhiteSpace(subject) || String.IsNullOrWhiteSpace(id))
            {
                return NotFound();
        ...
        public async Task<IActionResult> AddClientScopeAsync(string subject, ClientScopeValue model)
        {
            if (String.IsNullOrWhiteSpace(subject))
            {
                ModelState["subject.String"].Errors.Clear();
        ...
        public async Task<IActionResult> RemoveClientScopeAsync(string subject, string id)
        {
            if (String.IsNullOrWhiteSpace(subject) || String.IsNullOrWhiteSpace(id))
            {
                return NotFound();
