...
namespace IdentityAdmin.Api.Controllers
{
    ...
    public class ApiResourceController : Controller
    {
        ...
        public async Task<IActionResult> GetApiResourcesAsync(string filter = null, int start = 0, int count = 100)
        {
        ...
        public async Task<IActionResult> AddApiResourceClaimAsync(string subject, ApiResourceClaimValue model)
        {
            if (string.IsNullOrWhiteSpace(subject))
            {
                ModelState["subject.String"].Errors.Clear();
        ...
        public async Task<IActionResult> RemoveApiResourceClaimAsync(string subject, string id)
        {
        ...
        public async Task<IActionResult> AddApiResourceSecretAsync(string subject, ApiResourceSecretValue model)
        {
            if (string.IsNullOrWhiteSpace(subject))
            {
                ModelState["subject.String"].Errors.Clear();
        ...
        public async Task<IActionResult> RemoveApiResourceSecretAsync(string subject, string id)
        {
            if (string.IsNullOrWhiteSpace(subject) || string.IsNullOrWhiteSpace(id))
            {
                return NotFound();
        ...
        public async Task<IActionResult> UpdateApiResourceSecretAsync(string subject, ApiResourceSecretValue model)
        {
            if (string.IsNullOrWhiteSpace(subject))
            {
                ModelState["subject.String"].Errors.Clear();
        ...
        public async Task<IActionResult> RemoveApiResourceScopeAsync(string subject, string id)
        {
            if (string.IsNullOrWhiteSpace(subject) || string.IsNullOrWhiteSpace(id))
            {
                return NotFound();
        ...
        public async Task<IActionResult> UpdateApiResourceScopeAsync(string subject, ApiResourceScopeValue model)
        {
            if (string.IsNullOrWhiteSpace(subject))
            {
                ModelState["subject.String"].Errors.Clear();
        ...
        public async Task<IActionResult> RemoveApiResourceScopeClaimAsync(string subject, string id, string claimId)
        {
