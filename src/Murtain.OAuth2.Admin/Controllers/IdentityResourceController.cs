...
namespace IdentityAdmin.Api.Controllers
{
    ...
    public class IdentityResourceController : Controller
    {
        ...
        public async Task<IActionResult> GetIdentityResourcesAsync(string filter = null, int start = 0, int count = 100)
        {
        ...
        public async Task<IActionResult> GetIdentityResourceAsync(string subject)
        {
        ...
        public async Task<IActionResult> CreateIdentityResourceAsync(PropertyValue[] properties)
        {
        ...
        public async Task<IActionResult> DeleteIdentityResourceAsync(string subject)
        {
            var meta = await GetCoreMetaDataAsync();
        ...
        public async Task<IActionResult> AddIdentityResourceClaimAsync(string subject, IdentityResourceClaimValue model)
        {
            if (string.IsNullOrWhiteSpace(subject))
            {
                ModelState["subject.String"].Errors.Clear();
        ...
        public async Task<IActionResult> RemoveIdentityResourceClaimAsync(string subject, string id)
        {
