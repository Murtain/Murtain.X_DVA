...
(function (angular) {
    ...
    function ttPropertyEditor(PathBase){
        return {
            restrict:'E',
            templateUrl: PathBase + 'templates/editor/property.html',
            replace: true,
            scope: {
                property: '=',
    ...
    function ttPrompt(PathBase) {
        return {
            restrict: 'E',
            templateUrl: PathBase + 'templates/modal.html',
            replace: true,
            transclude: true,
            scope: {
                id: '@',
    ...
    function ttPagerButtons(PathBase) {
        return {
            restrict: 'E',
            templateUrl: PathBase + 'templates/pager/buttons.html',
            scope: {
                pager: '=',
                path: "@"
            }
    ...
    function ttPagerSummary(PathBase) {
        return {
            restrict: 'E',
            templateUrl: PathBase + 'templates/pager/summary.html',
            scope: {
                pager: '='
            }
        }
    ...
    function idAdmMessage(PathBase) {
        return {
            ...
            templateUrl: PathBase + 'templates/message.html',
            link: function (scope, elem, attrs) {
